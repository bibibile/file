...
<script>
  // ------------------ 哪吒面板基础配置 ------------------
  window.CustomBackgroundImage = "https://cdn.jsdelivr.net/gh/bibibile/file@1.1/Wallpaper.png"; // 【PC端背景】桌面端页面的主背景图片URL
  window.CustomMobileBackgroundImage = "https://cdn.jsdelivr.net/gh/bibibile/file@1.1/Wallpaper.png"; // 【移动端背景】移动端页面的主背景图片URL
  window.CustomLogo = "https://cdn.jsdelivr.net/gh/kamanfaiz/Nezha-Dash-UI@main/img/Pilgrim.png"; // 【LOGO】页面左上角的LOGO图片URL
  window.CustomDesc = "生命不止|折腾不息"; // 【描述】LOGO下方的描述文字
  ...
  window.CustomIllustration = "https://cdn.jsdelivr.net/gh/kamanfaiz/Nezha-Dash-UI@main/img/Candice.png"; // 【自定义插图】右下角的插图URL (需禁用人物动画)
  window.FixedTopServerName = false; // 【名称位置】是否将服务器名称固定在卡片顶部 (true/false)
  window.ForceTheme = ""; // 【强制主题】强制使用指定主题 ("light" 或 "dark", 留空则跟随系统)
</script>

<!-- 自定义链接 -->
<script src="https://cdn.jsdelivr.net/gh/bibibile/file@1.1/custom-links.js"></script>
